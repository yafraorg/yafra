...
static void Initialize P(( XbaeCaptionWidget request, XbaeCaptionWidget new,
			   ArgList args, Cardinal *num_args ));
static void InsertChild P(( Widget w ));
static Boolean SetValues P(( XbaeCaptionWidget current,
			     XbaeCaptionWidget request, XbaeCaptionWidget new,
			     ArgList args, Cardinal *num_args ));
static void SetValuesAlmost P(( XbaeCaptionWidget old, XbaeCaptionWidget new,
				XtWidgetGeometry *request,
				XtWidgetGeometry *reply ));
static void GetValuesHook P(( XbaeCaptionWidget cw, ArgList args,
			      Cardinal *num_args ));
static void Resize P(( XbaeCaptionWidget cw ));
static void ChangeManaged P(( XbaeCaptionWidget cw ));
static XtGeometryResult GeometryManager P(( Widget w,
					    XtWidgetGeometry *desired,
					    XtWidgetGeometry *allowed ));
static XtGeometryResult QueryGeometry P(( XbaeCaptionWidget cw,
 ...
 * Private functions
 */
static void ComputeSize P(( XbaeCaptionWidget cw, Dimension *cwWidth,
			    Dimension *cwHeight, Dimension childWidth,
			    Dimension cHeight, Dimension cBorderWidth ));
static void ComputeUserChildSize P(( XbaeCaptionWidget cw, Dimension cwWidth,
				     Dimension cwHeight, Dimension *childWidth,
				     Dimension *childHeight,
				     Dimension childBorderWidth ));

static void Layout P(( XbaeCaptionWidget cw, Boolean configure ));
static Boolean CompareStrings P(( String in, String test ));

/*
 * Type converters
 */
static Boolean CvtStringToLabelPosition P(( Display *dpy, XrmValuePtr args,
					    Cardinal *num_args,
					    XrmValuePtr from, XrmValuePtr to,
					    XtPointer *data ));
static Boolean CvtStringToLabelAlignment P(( Display *dpy, XrmValuePtr args,
					     Cardinal *num_args,
					     XrmValuePtr from, XrmValuePtr to,
					     XtPointer *data ));
