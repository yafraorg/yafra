 ...
 */
static void ClassPartInitialize P(( XbaeClipWidgetClass cwc ));
static void Realize P(( XbaeClipWidget cw, XtValueMask *valueMask,
			XSetWindowAttributes *attributes ));
static void Redisplay P(( XbaeClipWidget cw, XEvent *event, Region region ));
static void Redraw P(( XbaeClipWidget cw ));
 ...
 * Clip actions
 */
static void FocusInACT P(( XbaeClipWidget cw, XEvent *event, String *params,
			   Cardinal *nparams ));
