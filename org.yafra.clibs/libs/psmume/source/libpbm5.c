...
bit**	pbm_defaultfont( fcolsP, frowsP )
int* fcolsP;
int* frowsP;
{
	bit** defaultfont;
...
void pbm_dissectfont( font, frows, fcols, char_heightP, char_widthP, char_aheightP, char_awidthP, char_row0, char_col0 )
bit** font;
int frows;
int fcols;
int* char_heightP;
...
void pbm_dumpfont( font, fcols, frows )
bit** font;
int fcols;
int frows;
{
