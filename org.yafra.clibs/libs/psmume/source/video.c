 ...
 **************************************************************/
static char rcsid[]="$Header: /yafraorg/cvsroot/foundation/ansic/libs/psmume/source/video.c,v 1.1.1.1 2002-10-26 20:49:54 mwn Exp $";
 ...
 **************************************************************/
int PSMUMEvideoPlay(char *filename, char *server, int stereoflag, int loop)
{
	int status = 0;
