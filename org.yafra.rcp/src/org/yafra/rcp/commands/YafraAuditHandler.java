 ...
 * 
 */
public class YafraAuditHandler extends AbstractHandler
{
	...
	public Object execute(ExecutionEvent event) throws ExecutionException
		...
		glob.setDebugmessage(" - start YafraAudit command");
		...
		try
			{
			preferredWindow.getActivePage().showView("org.yafra.rcp.YafraAuditView");
			}
