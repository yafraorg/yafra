 ...
 * 
 */
public class YafraTechRoleHandler extends AbstractHandler
{
	...
	public Object execute(ExecutionEvent event) throws ExecutionException
		...
		glob.setDebugmessage(" - start YafraTechRole command");
		...
		try
			{
			preferredWindow.getActivePage().showView("org.yafra.rcp.YafraTechRoleView");
			}
