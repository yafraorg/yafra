 ...
 * 
 */
public class YafraUserHandler extends AbstractHandler
{
	...
	public Object execute(ExecutionEvent event) throws ExecutionException
		...
		glob.setDebugmessage(" - start YafraUserHandler command");
		...
		try
			{
			preferredWindow.getActivePage().showView("org.yafra.rcp.YafraUserView");
			}
