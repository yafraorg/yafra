...
#define RCSBASE "$Id: rcsbase.h,v 1.1.1.1 2002-10-26 17:08:12 mwn Exp $"
...
/*
 * $Log: rcsbase.h,v $
 * Revision 1.1.1.1  2002-10-26 17:08:12  mwn
 * init
 *
 * Revision 1.2  2002/05/27 17:16:08  mw
 * updates for mingw environment
 *
 * Revision 1.1  1997/09/18 10:21:46  mw
 * Initial revision
 *
...
#	define mainProg(n,c,i) char const Copyright[] = "Copyright 1982,1988,1989 Walter F. Tichy, Purdue CS\nCopyright 1990,1991,1992,1993,1994,1995 Paul Eggert", baseid[] = RCSBASE, cmdid[] = c; libId(n,i) int main P((int,char**)); int psidentMain mainArgs
#endif
