...
$dblang = $cgiinput->param(language);
$dbkunname = $cgiinput->param(mpkun_name);
$dbkunvor = $cgiinput->param(mpkun_vor);
$dbkunstr = $cgiinput->param(mpkun_str);
$dbkunplz = $cgiinput->param(mpkun_plz);
$dbkunort = $cgiinput->param(mpkun_ort);
$dbkunland = $cgiinput->param(mpkun_land);
$dbkuntel = $cgiinput->param(mpkun_tel);  
$dbkunfax = $cgiinput->param(mpkun_fax);  
$dbkunmail = $cgiinput->param(mpkun_mail);
$sen_name = $cgiinput->param(sentinel_name);
$sen_vor = $cgiinput->param(sentinel_vor);

#
# Datum : müssen jeweils noch umgeformt werden
#

$bday = $cgiinput->param(bday);   
$bmonth = $cgiinput->param(bmonth);   
$byear = $cgiinput->param(byear); 

$fday = $cgiinput->param(fday);    
$fmonth = $cgiinput->param(fmonth);
$fyear = $cgiinput->param(fyear);  

$tday = $cgiinput->param(tday);    
$tmonth = $cgiinput->param(tmonth);
$tyear = $cgiinput->param(tyear);  
...
<FORM NAME="myForm" METHOD="POST" ACTION="..mpto/formtest.pl">
...
<PRE>
                                                                      Birthday
Type         Sex       Name                   First Name              Day    Month   Year

<SELECT NAME="type" SIZE=1 WITDH=10>
<OPTION VALUE="adult" >Adult <OPTION VALUE="baby" >Baby 
<OPTION VALUE="juvenile" >Juvenile <OPTION VALUE="child" >Child <OPTION VALUE="retired" >Retired
</SELECT> <INPUT TYPE=radio NAME="mpkun_sex" CHECKED VALUE="f">f <INPUT TYPE=radio NAME="mpkun_sex" VALUE="m">m  <INPUT NAME="mpkun_name" TYPE=TEXT SIZE=20 MAX=20 VALUE="$sen_name"> <INPUT NAME="mpkun_vor" TYPE=TEXT SIZE=20 MAX=20 VALUE=$sen_vor>  <SELECT Name="bday" SIZE= 1 ALIGN=CENTER WIDTH=2 >
...
</SELECT>  <SELECT Name="bmonth" SIZE= 1 ALIGN=CENTER WIDTH=2 VALUE=$bmonth>                          
<OPTION VALUE=1>01 <OPTION VALUE=2>02 <OPTION VALUE=3>03 <OPTION VALUE=4>04             
<OPTION VALUE=5>05 <OPTION VALUE=6>06 <OPTION VALUE=7>07 <OPTION VALUE=8>08             
<OPTION VALUE=9>09 <OPTION VALUE=10>10 <OPTION VALUE=11>11 <OPTION VALUE=12>12          
</SELECT>  <SELECT Name="byear" SIZE= 1 ALIGN=CENTER WIDTH=4 VALUE=$byear>                           
...
<OPTION VALUE="adult" >Adult <OPTION VALUE="baby" >Baby 
<OPTION VALUE="juvenile" >Juvenile <OPTION VALUE="child" >Child <OPTION VALUE="retired" >Retired
</SELECT> <INPUT TYPE=radio NAME="mpkun_sex" CHECKED VALUE="f">f <INPUT TYPE=radio NAME="mpkun_sex" VALUE="m">m  <INPUT NAME="mpkun_name" TYPE=TEXT SIZE=20 MAX=20 > <INPUT NAME="mpkun_vor" TYPE=TEXT SIZE=20 MAX=20 >  <SELECT Name="bday" SIZE= 1 ALIGN=CENTER WIDTH=2 >
<OPTION VALUE=1>01 <OPTION VALUE=2>02 <OPTION VALUE=3>03 <OPTION VALUE=4>04             
<OPTION VALUE=5>05 <OPTION VALUE=6>06 <OPTION VALUE=7>07 <OPTION VALUE=8>08             
<OPTION VALUE=9>09 <OPTION VALUE=10>10 <OPTION VALUE=11>11 <OPTION VALUE=12>12          
<OPTION VALUE=13>13 <OPTION VALUE=14>14 <OPTION VALUE=15>15 <OPTION VALUE=16>16         
