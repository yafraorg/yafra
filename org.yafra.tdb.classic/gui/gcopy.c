...
/*R
 RCS Information:
 $Header: /yafra/cvsroot/mapo/source/gui/gcopy.c,v 1.2 2008-11-02 19:55:47 mwn Exp $
 ...
 Revision 2.1  1994/03/28 11:02:18  ja
 general version

 * Revision 1.3  94/02/18  10:36:12  10:36:12  ja (Jean-Marc Adam)
 * Name conversion for DOS
 * 
 * Revision 1.2  93/08/20  23:54:30  23:54:30  ja (Jean-Marc Adam)
 * update
 *  
 * 
*/
...
static char rcsid[]="$Header: /yafra/cvsroot/mapo/source/gui/gcopy.c,v 1.2 2008-11-02 19:55:47 mwn Exp $";
...

{
	...
	typ = graglob.eingabe;
	if (typ == 0) {
		XmTextSetString(grawidgets.frage, FRAGE_COPY0);
		graglob.eingabe = 1;
	} else if (typ == 1) {
		...
		if (!ok) return;
		XmTextSetString(grawidgets.frage, FRAGE_COPY1);
