...
namespace tdbadmin
{
	...
	/// </summary>
	public class FActType : System.Windows.Forms.Form
	{
		...
		private tdbgui.GUIactt AT;
		private tdb.DS.ActparaDS apDS;
		...
		{
			AT.InsUpd(true, tdb_e_bez.Text, tdb_e_code.Text, tdb_e_text.Text);
			tdb_e_id.Text = AT.ObjId.ToString();
		}

		private void TDB_ab_upd_Click(object sender, System.EventArgs e)
		{
			AT.InsUpd(false, tdb_e_bez.Text, tdb_e_code.Text, tdb_e_text.Text);
		}
