...
namespace tdbadmin
{
	...
	/// </summary>
	public class FCustomType : System.Windows.Forms.Form
	{
		...
		void TDB_ab_sel_Click_Return(object sender, EventArgs e) 
		{
			...
			id = Fsel.GetID;
			CT.Get(id, ref rows);
			tdb_e_id.Text = CT.ObjId.ToString();
			tdb_e_bez.Text = CT.ObjBez;
			tdb_e_code.Text = CT.ObjCode;
			tdb_e_text.Text = CT.ObjText;
		}
		...
		{
			CT.InsUpd(true, tdb_e_bez.Text, tdb_e_code.Text, tdb_e_text.Text);
			tdb_e_id.Text = CT.ObjId.ToString();
		}

		private void TDB_ab_upd_Click(object sender, System.EventArgs e)
		{
			CT.InsUpd(false, tdb_e_bez.Text, tdb_e_code.Text, tdb_e_text.Text);
		}

		private void TDB_ab_del_Click(object sender, System.EventArgs e)
		{
			int rows = 0;
			CT.Get(Convert.ToInt32(tdb_e_id.Text), ref rows);
			CT.Delete();
		}
