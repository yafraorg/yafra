...
namespace tdbadmin
{
	...
	/// </summary>
	public class FGrpType : System.Windows.Forms.Form
	{
		...
		void TDB_ab_sel_Click_Return(object sender, EventArgs e) 
		{
			...
			id = Fsel.GetID;
			GT.Get(id, ref rows);
			tdb_e_id.Text = GT.ObjId.ToString();
			tdb_e_bez.Text = GT.ObjBez;
			tdb_e_code.Text = GT.ObjCode;
			tdb_e_text.Text = GT.ObjText;
		}
		...
		{
			GT.InsUpd(true, tdb_e_bez.Text, tdb_e_code.Text, tdb_e_text.Text);
			tdb_e_id.Text = GT.ObjId.ToString();
		}

		private void TDB_ab_upd_Click(object sender, System.EventArgs e)
		{
			GT.InsUpd(false, tdb_e_bez.Text, tdb_e_code.Text, tdb_e_text.Text);
		}

		private void TDB_ab_del_Click(object sender, System.EventArgs e)
		{
			int rows = 0;
			GT.Get(Convert.ToInt32(tdb_e_id.Text), ref rows);
			GT.Delete();
		}
