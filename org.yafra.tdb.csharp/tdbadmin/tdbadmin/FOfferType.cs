...
namespace tdbadmin
{
	...
	/// </summary>
	public class FOfferType : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.Name = "FOfferType";
			this.Text = "Offer Type";
		...
		void TDB_ab_sel_Click_Return(object sender, EventArgs e) 
		{
			...
			id = Fsel.GetID;
			OT.Get(id, ref rows);
			tdb_e_id.Text = OT.ObjId.ToString();
			tdb_e_bez.Text = OT.ObjBez;
			tdb_e_text.Text = OT.ObjText;
		}
		...
		{
			OT.InsUpd(true, tdb_e_bez.Text, tdb_e_text.Text);
			tdb_e_id.Text = OT.ObjId.ToString();
		}

		private void TDB_ab_upd_Click(object sender, System.EventArgs e)
		{
			OT.InsUpd(false, tdb_e_bez.Text, tdb_e_text.Text);
		}

		private void TDB_ab_del_Click(object sender, System.EventArgs e)
		{
			int rows = 0;
			OT.Get(Convert.ToInt32(tdb_e_id.Text), ref rows);
			OT.Delete();
		}
