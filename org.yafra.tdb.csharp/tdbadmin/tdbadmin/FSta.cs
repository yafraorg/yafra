...
namespace tdbadmin
{
	...
	/// Status values Form
	/// </summary>
	public class FSta : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Label Sta_l_sta;
		private System.Windows.Forms.Label Sta_l_cond;
		private System.Windows.Forms.ComboBox Sta_e_typ;
		private System.Windows.Forms.Label Sta_l_typ;
		private System.Windows.Forms.TextBox Sta_e_sta;
		private System.Windows.Forms.TextBox Sta_e_cond;
		private tdbgui.GUIsta STA;
		private DataTable Ctyp;
		...
		private void InitializeComponent()
		{
			...
			this.Sta_e_cond = new System.Windows.Forms.TextBox();
			this.Sta_e_sta = new System.Windows.Forms.TextBox();
			this.Sta_l_typ = new System.Windows.Forms.Label();
			this.Sta_e_typ = new System.Windows.Forms.ComboBox();
			this.Sta_l_cond = new System.Windows.Forms.Label();
			this.Sta_l_sta = new System.Windows.Forms.Label();
			...
			// groupBox1
			// 
			this.groupBox1.Controls.Add(this.Sta_e_cond);
			this.groupBox1.Controls.Add(this.Sta_e_sta);
			this.groupBox1.Controls.Add(this.Sta_l_typ);
			this.groupBox1.Controls.Add(this.Sta_e_typ);
			this.groupBox1.Controls.Add(this.Sta_l_cond);
			this.groupBox1.Controls.Add(this.Sta_l_sta);
			...
			// Sta_e_cond
			// 
			this.Sta_e_cond.Location = new System.Drawing.Point(136, 160);
			this.Sta_e_cond.Name = "Sta_e_cond";
			this.Sta_e_cond.Size = new System.Drawing.Size(456, 20);
			this.Sta_e_cond.TabIndex = 15;
			this.Sta_e_cond.Text = "";
			// 
			// Sta_e_sta
			// 
			this.Sta_e_sta.Location = new System.Drawing.Point(136, 136);
			this.Sta_e_sta.Name = "Sta_e_sta";
			this.Sta_e_sta.Size = new System.Drawing.Size(456, 20);
			this.Sta_e_sta.TabIndex = 14;
			this.Sta_e_sta.Text = "";
			// 
			// Sta_l_typ
			// 
			this.Sta_l_typ.Location = new System.Drawing.Point(8, 16);
			this.Sta_l_typ.Name = "Sta_l_typ";
			this.Sta_l_typ.TabIndex = 13;
			this.Sta_l_typ.Text = "Select status type:";
			// 
			// Sta_e_typ
			// 
			this.Sta_e_typ.Location = new System.Drawing.Point(136, 16);
			this.Sta_e_typ.Name = "Sta_e_typ";
			this.Sta_e_typ.Size = new System.Drawing.Size(264, 21);
			this.Sta_e_typ.TabIndex = 12;
			// 
			// Sta_l_cond
			// 
			this.Sta_l_cond.Location = new System.Drawing.Point(8, 160);
			this.Sta_l_cond.Name = "Sta_l_cond";
			this.Sta_l_cond.TabIndex = 11;
			this.Sta_l_cond.Text = "Condition";
			// 
			// Sta_l_sta
			// 
			this.Sta_l_sta.Location = new System.Drawing.Point(8, 136);
			this.Sta_l_sta.Name = "Sta_l_sta";
			this.Sta_l_sta.TabIndex = 10;
			this.Sta_l_sta.Text = "Status";
			// 
			// tdb_e_id
			// 
			this.tdb_e_id.Location = new System.Drawing.Point(136, 72);
			...
			// tdb_e_bez
			// 
			this.tdb_e_bez.Location = new System.Drawing.Point(136, 88);
			...
			// tdb_e_code
			// 
			this.tdb_e_code.Location = new System.Drawing.Point(136, 112);
			...
			// tdb_l_code
			// 
			this.tdb_l_code.Location = new System.Drawing.Point(8, 112);
			...
			// tdb_l_id
			// 
			this.tdb_l_id.Location = new System.Drawing.Point(8, 72);
			...
			this.TDB_abgrp.Size = new System.Drawing.Size(600, 53);
			...
			this.TDB_ab_clr.Location = new System.Drawing.Point(447, 16);
			...
			this.TDB_ab_exit.Location = new System.Drawing.Point(522, 16);
			...
			this.Load += new System.EventHandler(this.FSta_Load);
		...
		{
			STA.InsUpd(true, tdb_e_bez.Text, Sta_e_sta.Text, tdb_e_code.Text, Convert.ToDouble(Sta_e_cond.Text), (int)Sta_e_typ.SelectedValue);
			tdb_e_id.Text = STA.ObjId.ToString();
		}

		private void TDB_ab_upd_Click(object sender, System.EventArgs e)
		{
			STA.InsUpd(false, tdb_e_bez.Text, Sta_e_sta.Text, tdb_e_code.Text, Convert.ToDouble(Sta_e_cond.Text), (int)Sta_e_typ.SelectedValue);
		}
		...
		private void TDB_ab_del_Click(object sender, System.EventArgs e)
		{
			int rows = 0;
			STA.ObjTyp = (int)Sta_e_typ.SelectedValue;
			STA.Get(Convert.ToInt32(tdb_e_id.Text), ref rows);
			STA.Delete();
		}
		...
		private void FSta_Load(object sender, System.EventArgs e)
		{
			STA.SetComboTyp(this.Sta_e_typ);
		}
