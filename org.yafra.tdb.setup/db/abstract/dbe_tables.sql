...
DLA_ID 		integer  NULL,
DL_ID 		integer  NULL,
DL_VONDAT	integer  NULL,
DL_BISDAT	integer  NULL,
TEXTID		integer  NULL,
OPT_DAT		integer  NULL,
SAI_ID		integer	NOT NULL,
REF			varchar(256)  NULL,
...
BUSY			integer  NULL,
MINANZ		integer  NULL,
VON_DAT 		integer	NOT NULL,
BIS_DAT 		integer	NOT NULL,
...
SAI_ID	integer	NOT NULL,
PRG_ID	integer	NOT NULL,
A_ZEIT	integer	NOT NULL,
E_ZEIT	integer	NOT NULL,
...
DAU			integer  NULL,
DAU_VON		integer  NULL,
DAU_BIS		integer  NULL,
primary key (PRE_ID),
foreign key (WHR_ID) references waehrung (WHR_ID),
foreign key (KBST) references personen (PERS_ID),
foreign key (KAR_ID) references kosten_art (KAR_ID),
