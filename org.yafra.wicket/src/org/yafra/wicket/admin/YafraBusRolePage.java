...
public class YafraBusRolePage extends AdminPage
	{
	private static final long serialVersionUID = 1L;

	public YafraBusRolePage()
		{
		PageableListView personslist = new PageableListView("yafrabrole", getRoles(), 15)
			{
				private static final long serialVersionUID = 1L;
				...
				protected void populateItem(ListItem item)
					{
					MYafraBusinessRole role = (MYafraBusinessRole) item.getModelObject();
	...
	private List<MYafraBusinessRole> getRoles()
		{
		AdminSession s = getAdminSession();
		Logging l = s.getLogging();
		l.logDebug("internet - get all roles");
		MHYafraBusinessRole mhyr = new MHYafraBusinessRole(s.getDataContext(), l);
		return mhyr.getMBusinessRoles();
		}
